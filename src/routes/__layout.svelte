...
<nav>
	...
	<div class="menu">
		<select id="category-select">
			...
			<option value="#general">general self-care</option>
			<option value="#crisis-tools">tools to use right now</option>
			<option value="#work">burnout prevention</option>
			<option value="#recovery">burnout recovery</option>
			<option value="#exercises">exercise and health</option>
			<option value="#meditationresources">meditation resources</option>
			<option value="#meditations">meditations &amp; tools</option>
			<option value="#podcasts">podcasts</option>
			<option value="#newsletters">newsletters</option>
			<option value="#uplift">uplift &amp; positivity</option>
			<option value="#humane">humane tech</option>
			<option value="#journaling">self-exploration</option>
			<option value="#offline">offline activities</option>
			<option value="#tools-app">general tools &amp; apps</option>
			<option value="#noise">noise generators</option>
			<option value="#gaming">helpful games</option>
			<option value="#bots">self care bots</option>
			<option value="#talks">talks &amp; articles</option>
			<option value="#building">building self-care tools</option>
		</select>
	</div>
</nav>
